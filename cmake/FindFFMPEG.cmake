...
find_path(FFMPEG_INCLUDE_DIR
	...
	PATHS ${AVCODEC_PKGCONF_INCLUDE_DIRS} ${AVFORMAT_PKGCONF_INCLUDE_DIRS} ${AVUTIL_PKGCONF_INCLUDE_DIRS} ${FFMPEG_DIR}/include
)

# Libraries
find_library(AVCODEC_LIBRARY
	NAMES avcodec
	PATHS ${AVCODEC_PKGCONF_LIBRARY_DIRS} ${FFMPEG_DIR}/lib
)

find_library(AVFORMAT_LIBRARY
	NAMES avformat
	PATHS ${AVFORMAT_PKGCONF_LIBRARY_DIRS} ${FFMPEG_DIR}/lib
)

find_library(AVUTIL_LIBRARY
	NAMES avutil
	PATHS ${AVUTIL_PKGCONF_LIBRARY_DIRS} ${FFMPEG_DIR}/lib
)
